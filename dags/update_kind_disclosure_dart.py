    ...
    try:
        ...
        with engine.connect() as conn:
            ...
            for record in records:
                ...
                disclosed_at = record[2]
                dart_unique_id = record[3]
...
@dag(
    dag_id="update_kind_disclosure_raw_dart_dag",
    ...
    params={
        "disclosure_type": "타법인 주식 및 출자증권 양수결정",
    },
)
def update_kind_disclosure_raw_dart_dag():

    @task
    def update_kind_disclosure_raw_dart_task(**context) -> str:
        """
    ...
    # 태스크 실행
    update_kind_disclosure_raw_dart_task()


# DAG 인스턴스 생성
dag_instance = update_kind_disclosure_raw_dart_dag()
